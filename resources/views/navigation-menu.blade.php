<nav x-data="{ open: false }" class="bg-gray-800 border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('analisis') }}" :active="request()->routeIs('analisis')">
                {{ __('Análisis') }}
            </x-jet-responsive-nav-link>

            <x-jet-responsive-nav-link href="{{ route('resultados') }}" :active="request()->routeIs('resultados')">
                {{ __('Resultados') }}
            </x-jet-responsive-nav-link>
        </div>
